  ...
  <div className="main__main-container">
    ...
    <div className="main__subtitle-views-likes-container">
      <div className="main__subtitle-container">
        <h2 className="main__subtitle-container--author">{object.channel}</h2>
        <h2 className="main__subtitle-container--date">{object.timestamp}</h2>
      </div>
      <div className="main__views-likes-container">
        <div className="main__views-container">
          ...
          <h2 className="main__views-container--number">{object.views}</h2>
        </div>
        <div className="main__likes-container">
          <img className="main__likes-container--icon" src={heart} alt="" />
          <h2 className="main__likes-container--number">{object.likes}</h2>
        </div>
      </div>
    </div>
    <div className="main__description-container">
      <p className="main__description-container--text">{object.description}</p>
    </div>
  </div>
</div>
